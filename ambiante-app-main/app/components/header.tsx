...
import { View, StyleSheet, Text, useWindowDimensions, Pressable, Image } from 'react-native';
  ...
  return (
    <SafeAreaView>
      ...
      <View style={[styles.header, darkMode && styles.headerDark]}>
        ...
        <Image source={require('../imgP/bannerCarousel/logo.png')} style={styles.imagemLogo}/>

        <Link href="/(tabs)/main" asChild>
          <Text style={styles.titulo }>ClickMarket 🛒</Text>
        </Link>
